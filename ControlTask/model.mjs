...
function generateSurface() {
    ...
    return { vertices, normals, tangets, uvs, indices };
}
...
export default function Model(gl, shProgram) {
    ...
    this.CreateSurfaceData = function() {
        const { vertices, normals, tangets, uvs, indices } = generateSurface();
        this.BufferData(vertices, normals, tangets, uvs, indices);
    }
}
